...
/**
 * @brief Cleans up allocated resources and shuts down initialized Allegro
 * components.
 *
 ...
 * images, and keyboard handling. Tracks initialization status in Flags for safe
 * cleanup.
 *
 ...
 *
 * Initializes Allegro, creates the game instance, and starts the main game
 * loop. Handles cleanup in case of initialization errors.
 *
...
int main() {
  ...
  Flags flags = {false, false, false,
                 false, false, false}; // Initialize all flags to false
 ...
 *
 * Centers the window on the main display and sets the window title to "Space
 * Invaders."
 *
 * @param game Pointer to the GAME instance.
 */
 ...
 * components.
 *
 * Destroys the game instance and shuts down Allegro modules based on
